...
class _AddTaskPageWidgetState extends State<AddTaskPageWidget> {
  ...
  void initState() {
    ...
    _model.taskDetailsFieldTextController ??= TextEditingController();
    _model.taskDetailsFieldFocusNode ??= FocusNode();
            ...
            children: [
              Container(
                ...
                child: TextFormField(
                  ...
                  validator: _model.taskTitleFieldTextControllerValidator
                      .asValidator(context),
                ),
              ),
              Container(
                width: 200.0,
                child: TextFormField(
                  controller: _model.taskDetailsFieldTextController,
                  focusNode: _model.taskDetailsFieldFocusNode,
                  autofocus: false,
                  enabled: true,
                  obscureText: false,
                  decoration: InputDecoration(
                  ...
                  cursorColor: FlutterFlowTheme.of(context).primaryText,
                  enableInteractiveSelection: true,
                  validator: _model.taskDetailsFieldTextControllerValidator
                      .asValidator(context),
                ),
              ),
              FFButtonWidget(
                onPressed: () async {
                  await TasksRecord.collection.doc().set({
                    ...createTasksRecordData(
                      title: _model.taskTitleFieldTextController.text,
                      details: _model.taskDetailsFieldTextController.text,
                      completed: false,
